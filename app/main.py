...
app.include_router(any_cloud.router_ops, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_provider, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_credential, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_addon, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_admin, prefix=settings.API_V1_STR)
